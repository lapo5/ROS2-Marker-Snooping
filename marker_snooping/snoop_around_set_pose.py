...
class MarkerSnooper(Node):
	def __init__(self):
		...
		self.req_set_pose = SetPose.Request()
		self.req_set_pose.pose = PoseWithCovarianceStamped()
		self.req_set_pose.pose.header = Header()
		self.req_set_pose.pose.header.stamp = self.get_clock().now().to_msg()
		self.req_set_pose.pose.header.frame_id = "zed_link"

		self.req_set_pose.pose.pose.pose.position.x = -1.0
		self.req_set_pose.pose.pose.pose.position.y = -1.0
		self.req_set_pose.pose.pose.pose.position.z = 0.0

		self.req_set_pose.pose.pose.pose.orientation.x = 0.0
		self.req_set_pose.pose.pose.pose.orientation.y = 0.0
		self.req_set_pose.pose.pose.pose.orientation.z = 0.0
		self.req_set_pose.pose.pose.pose.orientation.w = 1.0
		for i in range(0, 6):
			self.req_set_pose.pose.pose.covariance[i * 7] = 0.1

		self.send_request_set_pose()
	...
	def callback_request_set_pose(self, future):
		try:
			...
			self.get_logger().info('Set Pose Results')
